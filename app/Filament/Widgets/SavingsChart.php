...
class SavingsChart extends ChartWidget {
    protected static ?string $heading = 'Savings Timeline';

    // Holds the results of the WhatIf Analysis
    public $chartData;
    ...
    protected function getData(): array {
        ...
        // Store timeline; Retrieve month count until full savings goal.
    ...
    protected function getType(): string {
        return 'line'; // Specify the type of chart you want to display (e.g., 'line', 'bar', etc.)
    }

 ...
 * Designed to display the result of monthly payment change scenario (Algo2) in WhatIfForm
 * Data Flow:
 *  - Data is generated by the `changeMonthlyPaymentScenario()` method in WhatIfForm
 *  - Passed to `what-if-form.blade.php` as `$result`
 *  - Recieved by this chart via `@livewire` directive in `what-if-form.blade.php`
 */

                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    <img
                                            src="{{ asset('images/welcome/banner.webp') }}"
                                            alt="Banner Image"
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black dark:text-white">Keeping You on Track for Financial Success</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                Many young adults in the U.S. struggle with their finances due to the overwhelming burden of student loans, ever increasing credit rates, and a lack of experience with crucial financial skills.
                                            </p>
                                            <p class="mt-4 text-sm/relaxed">
                                                Balancing the pressures of starting a career while facing financial uncertainty leads to the accumulation of debt, increased anxiety, and delayed life milestones such as marriage, home ownership, and starting a family.
                                            </p>
                                            <p class="mt-4 text-sm/relaxed">
                                                CreditTrax aims to empower young adults with personalized budgeting and debt management tools designed to simplify financial decisions, enhance financial literacy, and set them back on track for financial success.
                                            </p>
                                        </div>
                                    </div>

                                    <svg class="size-6 shrink-0 stroke-[#24B6AB]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75"/></svg>
                                </div>
                            </a>

                            <!-- What-If Analysis -->
                            <a
                                href="{{ Auth::check() ? route('whatif') : route('login') }}"
                                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full sm:size-20">
                                    <img src="{{ asset('images/welcome/what-if-icon.png') }}" alt="help--v1" class="w-full h-full object-contain"/>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">What-If Analysis</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Plan ahead with CreditTrax's innovative What-If Analysis tool, exploring how changes to your debt or savings can shape your financial future.
                                    </p>
                                    <ul class="list-disc pl-6 space-y-2 text-sm/relaxed text-gray-600 dark:text-gray-400 mt-4">
                                        <li>
                                            <strong class="font-semibold">Test Debt Scenarios:</strong>
                                            See how adjusting interest rates or payments impact your debt payoff timeline.
                                        </li>

                                        <li>
                                            <strong class="font-semibold">Save and Compare:</strong>
                                            Generate detailed reports, saved for future reference, to help guide your decisions.
                                        </li>

                                        <li>
                                            <strong class="font-semibold">Align with Goals:</strong>
                                            Apply financial goals to scenarios to confirm they stay on track for success.
                                        </li>
                                    </ul>
                                </div>

                                <svg class="size-6 shrink-0 self-center stroke-[#24B6AB]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75"/></svg>
                            </a>

                            <!-- AI Chatbot -->
                            <a
                                href="{{ Auth::check() ? route('finance') . '#chatbot' : route('login') }}"
                                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                            >

                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full sm:size-16">
                                    <img width="64" height="64" src="https://img.icons8.com/cotton/64/artificial-intelligence.png" alt="artificial-intelligence"/>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">AI Recommendations</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Get personalized guidance from CreditTrax's AI assistant, designed to answer questions, simplify desicions, and boost your confidence.
                                    </p>

                                    <ul class="list-disc pl-6 space-y-2 text-sm/relaxed text-gray-600 dark:text-gray-400 mt-4">
                                        <li>
                                            <strong>Your Personal AI Advisor:</strong>
                                            Chat with an AI that knows your debts, goals, and budget, offering you tailored tips on your financial situation at any time.
                                        </li>

                                        <li>
                                            <strong>Smart Report Inisghts:</strong>
                                            Discuss specific What-If analysis reports with your personal AI advisor to better understand your scenario and next steps.
                                        </li>

                                        <li>
                                            <strong>Budget Optimization:</strong>
                                            Receive real-time suggestions to optimize your budget.
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <!-- Finance -->
                            <a
                                href="{{ Auth::check() ? route('finance') : route('login') }}"
                                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full sm:size-16">
                                    <img width="96" height="96" src="https://img.icons8.com/color/96/banknotes.png" alt="banknotes"/>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Finance Tracking</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Receive a clear and organized view of your financial obligations. 
                                        Empowering you to take control over your debt.
                                    </p>

                                    <ul class="list-disc pl-6 space-y-2 text-sm/relaxed text-gray-600 dark:text-gray-400 mt-4">
                                        <li>
                                            <strong>All Debts, One Place:</strong>
                                            See and manage every debt in a single, easy-to-use table.
                                        </li>
                                        <li>
                                            <strong>Set and Track Goals:</strong>
                                            Create personalized financial goals and view your progress effortlessly.
                                        </li>
                                        <li>
                                            <strong>Track Your Payments:</strong>
                                            Log monthly debt payments, with interest and principal automatically calculated and updated.
                                        </li>
                                    </ul>
                                </div>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full sm:size-16">
                                    <img width="96" height="96" src="https://img.icons8.com/dusk/64/doughnut-chart--v1.png" alt="doughnut-chart--v1"/>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Personal Financial Dashboard</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Stay on track with a personalized financial dashboard that gives you a clear, real-time view of your financial health.
                                    </p>
                                    <ul class="list-disc pl-6 space-y-2 text-sm/relaxed text-gray-600 dark:text-gray-400 mt-4">
                                        <li>
                                            <strong class="font-semibold">Visualize your Finances:</strong>
                                            Track income, budget, and debt with convenient charts and graphs.
                                        </li>

                                        <li>
                                            <strong class="font-semibold">Monitor Goal Progress:</strong>
                                            Stay on top of your financial goals with dynamic progress sliders.
                                        </li>

                                        <li>
                                            <strong class="font-semibold">Stay Motivated:</strong>
                                            Earn badges, track payments, and stay motivated with inspirational quotes.
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <!-- Rewards -->
                            <a
                                href="{{ Auth::check() ? route('rewards') : route('login') }}"
                                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full sm:size-16">
                                <img width="64" height="64" src="https://img.icons8.com/cotton/64/trophy--v1.png" alt="trophy--v1"/>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Rewards and Achievements</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Stay motivated on your financial journey with rewards and achievements that celebrate your progress.
                                    </p>
                                    <ul class="list-disc pl-6 space-y-2 text-sm/relaxed text-gray-600 dark:text-gray-400 mt-4">
                                        <li>
                                            <strong class="font-semibold">Earn Badges:</strong>
                                            Earn badges by completing milestones throughout your financial journey.
                                        </li>

                                        <li>
                                            <strong class="font-semibold">Look Back on Your Achievements:</strong>
                                            View and inspect badges on your rewards page to look back on the details of your success.
                                        </li>

                                        <li>
                                            <strong class="font-semibold">Keep Count:</strong>
                                            Track the number of badges you have earned through a dedicated section on your dashboard.
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <!-- Community -->
                            <a
                                href="{{ Auth::check() ? route('community.index') : route('login') }}"
                                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full sm:size-16">
                                    <img width="96" height="96" src="https://img.icons8.com/color/96/people-working-together.png" alt="people-working-together"/>
                                </div>
                                ...
                                <div class="pt-3 sm:pt-5">
                                    ...
                                    <p class="mt-4 text-sm/relaxed">
                                    Join a supportive community to connect, collaborate, and share your financial journey with.
                                    </p>

                                    <ul class="list-disc pl-6 space-y-2 text-sm/relaxed text-gray-600 dark:text-gray-400 mt-4">
                                        <li>
                                            <strong class="font-semibold">Connect with Friends:</strong>
                                            Send friend requests to build a supportive network.
                                        </li>

                                        <li>
                                            <strong class="font-semibold">Form Groups:</strong>
                                            Join groups to collaborate on goals and talk financial strategy.
                                        </li>

                                        <li>
                                            <strong class="font-semibold">Share in Groups:</strong>
                                            Post updates in your groups to share tips, talk about accomplishments, and learn together.
                                        </li>
                                    </ul>
                                </div>

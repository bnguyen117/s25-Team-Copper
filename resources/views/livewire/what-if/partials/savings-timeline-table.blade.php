...
<div class="mb-6">
    ...
    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Savings Timeline</h3>
      ...
      <table class="w-full text-sm font-medium text-gray-800 dark:text-gray-200">
          ...
          <thead class="sticky top-0 bg-gradient-to-tl from-gray-200 to-gray-50 dark:from-gray-900 dark:to-gray-700 text-gray-900 dark:text-gray-100 shadow-md">
              ...
              <tr class="hidden md:table-row">
                  ...
                  <th class="px-4 py-3 text-right font-semibold text-gray-700 dark:text-gray-300">Interest Earned</th>
                  <th class="px-4 py-3 text-right font-semibold text-gray-700 dark:text-gray-300">Monthly Savings Rate</th>
                  <th class="px-4 py-3 text-right font-semibold text-gray-700 dark:text-gray-300">Balance</th>
              </tr>
          </thead>
            ...
            @foreach($report->timeline as $entry)
                ...
                <tr class="md:table-row block transition-colors hover:bg-gradient-to-r hover:from-gray-100 hover:to-gray-50 dark:hover:from-gray-800 dark:hover:to-gray-700">
                  ...
                  <!-- Mobile-only cell that stacks label-value pairs vertically -->
                    <td class="block md:hidden px-3 py-2 bg-gradient-to-tl from-gray-200 to-gray-50 dark:from-gray-900 dark:to-gray-700 rounded-lg shadow-md mb-4">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="flex justify-between">
                                <span class="font-semibold text-gray-700 dark:text-gray-300">Interest Earned:</span>
                                <span class="text-gray-900 dark:text-gray-100">${{ number_format($entry['interest_earned'], 2) }}</span>
                            </div>

                            <!-- Principal Paid label and value-->
                            <div class="flex justify-between">
                                <span class="font-semibold text-gray-700 dark:text-gray-300">Monthly Savings:</span>
                                <span class="text-gray-900 dark:text-gray-100">${{ number_format($entry['monthly_savings'], 2) }}</span>
                            </div>
                  ...
                  <td class="hidden md:table-cell px-4 py-2 text-right text-gray-900 dark:text-gray-100">
                      ${{ number_format($entry['interest_earned'], 2) }}
                  </td>
                  <td class="hidden md:table-cell px-4 py-2 text-right text-gray-900 dark:text-gray-100">
                      ${{ number_format($entry['monthly_savings'], 2) }}
                  </td>
                  <td class="hidden md:table-cell px-4 py-2 text-right text-gray-900 dark:text-gray-100">
